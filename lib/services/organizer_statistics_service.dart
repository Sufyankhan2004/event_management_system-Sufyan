  ...
  Future<OrganizerStatisticsModel> updateStatistics(String organizerId) async {
    try {
      ...
      for (final event in events) {
        final attendees = await _registrationService.getEventAttendeesCount(event.id);
        totalAttendees += attendees;
        
        // Get registrations for revenue calculation
        final registrations = await _registrationService.getEventRegistrations(event.id);
